...
#if _DEBUG
// Previously this file rendered a small Boss Debug ImGui panel inline. That UI is now centralized in DebugTuningPanel.
...
#if _DEBUG
	// Debug UI moved to DebugTuningPanel. No inline ImGui here to avoid duplication.
#endif
